        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[550px] rounded-none border-border/60">
                <form onSubmit={handleSubmit}>
                    <DialogHeader>
                        <DialogTitle className="text-2xl font-semibold tracking-tight">Create New Agent</DialogTitle>
                        <DialogDescription>
                    ...
                    <div className="grid gap-6 py-6">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Select onValueChange={handlePersonaSelect}>
                                    <SelectTrigger id="persona-template" className="rounded-none border-border/60">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="persona" className="text-sm font-medium">System Prompt / Persona</Label>
                            <Textarea
                                id="persona"
                                placeholder="Define how the agent should behave..."
                                className="rounded-none border-border/60 min-h-[150px] resize-none"
