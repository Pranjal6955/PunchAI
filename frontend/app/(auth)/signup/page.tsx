...
export default function SignupPage() {
    ...
    const onSubmit = async (data: SignupFormValues) => {
        ...
        try {
            ...
            localStorage.setItem("user", JSON.stringify({ _id: resData._id, fullName: resData.fullName, email: resData.email }));
    ...
    return (
        <div className="flex flex-col min-h-screen items-center justify-center bg-muted/30 p-4">
            ...
            <Card className="w-full max-w-[400px] shadow-lg border-border/60 mb-8">
                ...
                <CardContent>
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        {error && (
                            <div className="p-3 text-sm font-medium text-destructive bg-destructive/10 rounded-md border border-destructive/20 text-center animate-in fade-in zoom-in-95 duration-200">
                                {error}
                            </div>
                        )}
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                {...register("fullName")}
                                disabled={isLoading}
                                className={`transition-colors ${errors.fullName ? "border-destructive focus-visible:ring-destructive" : ""}`}
                            />
                            {errors.fullName && (
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                disabled={isLoading}
                                className={`transition-colors ${errors.confirmPassword ? "border-destructive focus-visible:ring-destructive" : ""}`}
                            />
