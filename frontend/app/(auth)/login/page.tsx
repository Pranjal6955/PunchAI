                ...
                <div className="flex flex-col items-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    ...
                    <div className="flex flex-col items-center space-y-4">
                        ...
                        <div className="text-center space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">Welcome back, let's get back to work</p>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col space-y-6 p-6">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-[10px] uppercase">
                                    <span className="bg-card px-2 text-muted-foreground/60 tracking-widest font-medium">Or log in with email</span>
                                </div>
                            </div>
                    ...
                    <p className="text-center text-[10px] text-muted-foreground/60 leading-relaxed max-w-[280px]">
                        By logging in, you agree to Punch AI's Terms of Service and Privacy Policy.
                    </p>
                </div>
            </main>
